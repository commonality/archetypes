...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Locale.LocalesApi();
  });
  ...
  describe('LocalesApi', function() {
    describe('getLocaleById', function() {
      it('should call getLocaleById successfully', function(done) {
        //uncomment below and update the code to test getLocaleById
        //instance.getLocaleById(function(error) {
