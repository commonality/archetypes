...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Locale.IsoCountryCode();
  });
  ...
  describe('IsoCountryCode', function() {
    it('should create an instance of IsoCountryCode', function() {
      ...
      //var instane = new Locale.IsoCountryCode();
      //expect(instance).to.be.a(Locale.IsoCountryCode);
    });
    ...
    it('should have the property alphabeticThreeCharCode (base name: "alphabeticThreeCharCode")', function() {
      // uncomment below and update the code to test the property alphabeticThreeCharCode
      //var instane = new Locale.IsoCountryCode();
      //expect(instance).to.be();
    });
